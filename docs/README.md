...
ADRs written before D-140 cite `DECISIONS.md`, `BACKLOG.md` and `DEFERRED.md` at the repository
root, and ones written before D-139 cite `services/chemclaw/…`. Those references are left as
