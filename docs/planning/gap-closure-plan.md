...
> Companion to `docs/planning/implementation-tickets.md` (F0–F9) and `docs/planning/parity-plan.md` (F10). Same
...
Phase label: **F11**. ADRs are appended to `docs/decisions/` as D-083…D-085, one per wave.
