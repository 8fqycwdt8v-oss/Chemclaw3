# D-141 — The packages regrouped under `src/chemclaw/` by the four architecture layers
...
- `chemclaw/` inside repo `Chemclaw3` (and, until D-139, inside `services/chemclaw/`) — the same
