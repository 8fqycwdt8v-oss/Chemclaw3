...
| [D-2026-08-17-a-queue-row-is-a-claim-and-claims-go-stale](D-2026-08-17-a-queue-row-is-a-claim-and-claims-go-stale.md) | Every anchor in both registers checked against HEAD: BACKLOG 40 rows to 20, six DEFERRED reasons corrected, and three prose claims that became tests |
