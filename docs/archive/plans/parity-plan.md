...
Respecting the repo's "off-the-shelf / defer until measured" discipline (D-018 / docs/planning/DEFERRED.md), these are
...
notes. Recorded in `docs/decisions/` at implementation time (next running-log numbers), one per CHECKMATE.
