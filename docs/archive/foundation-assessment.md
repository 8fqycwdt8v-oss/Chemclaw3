...
> Skills or MCP tools now. Method: full read of the code, `docs/decisions/`, both design docs,
...
- **The eval/metric layer, the calc cache, fingerprint search, memory layers, config discipline,
  and the `docs/decisions/` log** — the engineering hygiene here is exemplary and rare.
