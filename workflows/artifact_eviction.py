...
an artifact is an optimization on top of it, and `calc.artifacts` states in its own contract that
an artifact may be absent. `calc.xtb_hessian` is built on exactly that: a cached Hessian whose blob
