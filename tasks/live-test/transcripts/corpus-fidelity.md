...
| prose reaches the step, and is not inferred as a headline | PASS | 12/12 procedures state a temperature and a time in prose, carry both on a step, and infer no headline |
| corpus is reachable | PASS | 4251/4251 mapped ORD records are stored as reaction records |
