...
## A test that skips is not a test that passes — and an infrastructure skip can often be removed (2026-07-31, D-155)

The Temporal-backed and Postgres-backed suites here skip in the sandbox, which is documented and
accepted. Working on D-155 I first wrote the write-path assertions into the Temporal e2e test and
