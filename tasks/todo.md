...
Branch: `claude/github-repo-structure-6yyibc`. Three ADRs: D-139, D-140, D-141.
...
- [x] `test_image_ships_every_first_party_package` went **vacuous**: it discovered root packages,
      and D-141 left none, so it iterated an empty set and passed. Replaced with an assertion that
