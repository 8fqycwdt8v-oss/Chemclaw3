...
`calc.xtb_props` already provides — no new xTB capability, only wiring.
...
from bo.problem import CategoricalParameter, OptimizationProblem
from calc.store import ResultStore
from calc.xtb_props import ElectronicProperties, run_cached_properties
