...
async def test_reaction_similarity_ranking_in_sql() -> None:
...
async def test_an_unbuilt_reaction_index_says_so_over_postgres() -> None:
...
async def test_a_single_source_deployment_reads_exactly_as_before() -> None:
...
async def test_the_molecule_index_refuses_a_sourced_record() -> None:
