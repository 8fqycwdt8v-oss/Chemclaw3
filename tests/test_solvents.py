...
def test_every_declared_job_that_takes_a_solvent_declares_the_precondition() -> None:
    """The rule is only worth anything on the jobs that can violate it — all five of them.

    Derived from the manifests and their params models rather than a written-down list, so a sixth
