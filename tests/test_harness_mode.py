...
def test_a_changed_plan_has_a_different_hash() -> None:
    ...
    to use. That helper writes the system-authored `awaiting-job:` row, and D-164 excludes those
...
def test_ticking_a_box_does_not_change_the_plans_identity() -> None:
    """Working through an approved plan must not revoke the approval it is working under (D-164).
