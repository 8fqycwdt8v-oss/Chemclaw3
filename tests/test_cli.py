...
def test_admin_identity_advertises_all_skills_as_the_configured_actor() -> None:
    """Admin mode returns the configured actor and no skill restriction (all skills visible)."""
    actor, allowed = cli.resolve_identity(admin=True, actor=None)
