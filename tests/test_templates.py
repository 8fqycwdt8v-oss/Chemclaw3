...
def test_a_bundle_that_cannot_be_imported_stops_the_template_gate(
    ...
    Measured on this tree with one missing import injected into `connectors/chem/server/tools.py`: 50
    signatures became 46 and `make template-validate` printed "template validation passed" and
