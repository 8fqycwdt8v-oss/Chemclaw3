...
def test_agent_audits_and_authorizes_every_tool_call() -> None:
    """Seven middlewares attach: surfacing x2, audit, authz, dry-run, repeat guard, announcing."""
    ...
    # Unconditional for the same reason: a turn that loops on one retrieval costs the turn, and
    # the loop cap bounds harness iterations rather than identical calls (2026-08-04 live run).
