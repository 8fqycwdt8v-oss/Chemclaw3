...
`agents.profiles` holds the *contract* — the override bundle and the `{name: profile}` registry —
...
Discovery is not enablement of *capability*: a profile can only ever narrow (`agents.profiles`),
...
from agents.profiles import AgentProfile, register_profile, registered_profile_names
from chemclaw.config import settings
from connectors.registry import profiles_dirs as connector_profiles_dirs
