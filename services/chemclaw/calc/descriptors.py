...
solubility model (`calc.solubility`). Chemists routinely need the panel itself — molecular weight,
...
def _calc_version() -> str:
    ...
    can shift a value; keying on its version is enough (mirrors `calc.solubility`).
    """
