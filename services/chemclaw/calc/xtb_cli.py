...
`calc.xtb_thermo`. One RRHO implementation — the one validated against water's measured
...
def _task_flags(task: CliTask) -> list[str]:
    ...
    the gradient tolerance `calc.xtb_opt` promises — measured, ethanol stops at 6.3e-4
