...
This is the batch driver. It reuses `agents.attachments`' parsers verbatim (one parsing
...
Run: `python -m scripts.backfill_corpus <directory> [--dry-run] [--tag PROJECT]`
"""
...
from agents.attachments import AttachmentError, parse_attachment
