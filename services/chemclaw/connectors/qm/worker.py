...
Run it with `python -m connectors.qm.worker`. It polls `connector-qm` and serves whatever importing
...
from connectors.qm import activities as _activities  # noqa: F401 — registration side effect
from connectors.qm import workflows as _workflows  # noqa: F401 — registration side effect
