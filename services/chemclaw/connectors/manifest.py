...
class JobSpec(BaseModel):
    ...
    job's result carries — the write still goes through `kg.pr_gate`, never through the
    connector.
    """
...
class ConnectorManifest(BaseModel):
    ...
    same reason `sources.base.SourceSpec` rejects a source with neither half: a connector that
