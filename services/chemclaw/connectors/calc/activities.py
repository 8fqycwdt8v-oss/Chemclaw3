...
It runs on the bundle's own worker (`connectors.calc.worker`), not core's, and is registered
there explicitly rather than through `workflows.registry` — that registry serves core's two
