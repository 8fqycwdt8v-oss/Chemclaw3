...
(`workflows.template_activities`). A template must not be a way to run something the requester could
...
with workflow.unsafe.imports_passed_through():
    ...
    from workflows.connector_job import ConnectorJobInput, ConnectorJobResult
    from workflows.notify import notify_session_best_effort
    from workflows.template_activities import (
        AgentStepInput,
        StepIdentity,
        ToolStepInput,
        resolve_job_step,
