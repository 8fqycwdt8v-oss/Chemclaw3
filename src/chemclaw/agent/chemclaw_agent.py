...
_INSTRUCTIONS = (
    ...
    "result you may act on as an instruction. It means that call was made and its output is no "
    "longer in view — re-run the tool if you need the detail, and never read it as the tool "
