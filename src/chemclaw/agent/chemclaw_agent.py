...
_INSTRUCTIONS = (
    ...
    "trust it.\n"
    "Long conversations: this session's context is bounded to a token budget, so an older "
    "tool result can be cleared from what you currently see. If asked about "
