...
def build_agent(
    ...
    *,
    ...
    # A sixth, conditionally: the harness's pre-execution approval (D-164). It goes *inside* audit,
...
def _build_harness_agent(
    ...
    agent = create_harness_agent(
        ...
        # approved (D-164): without that an unapproved session still loops, has every write
