...
note writer's cluster advisory lock (`kg/git_writer.py::_cluster_lock`, which outlived the PR-gate
it was built under) closed the git half there is exactly one such dependency left:
