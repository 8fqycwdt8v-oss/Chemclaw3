...
the web. A stable, source-agnostic harness core (`chemclaw.retrieval.harness`) knows only the
retriever
contract (`chemclaw.retrieval.evidence`); concrete retrievers (`chemclaw.retrieval.retrievers`) are
thin adapters over
