...
about Temporal, and the modules that need to report progress (`chemclaw.science.calc.reaction`,
`chemclaw.science.calc.xtb_scan`) must not import each other to share the type. The durable activity
