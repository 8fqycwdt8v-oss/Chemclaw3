...
connections are short-lived and borrowed through `chemclaw.db.connection`.
"""
...
class PostgresArtifactStore:
    ...
    pool underneath `chemclaw.db.connection` already removes the handshake where it matters.
    """
...
def default_artifact_store() -> ArtifactStore:
    ...
    The one place that names the production backend, mirroring `calc.postgres_store.default_store`
