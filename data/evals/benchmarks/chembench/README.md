...
`data/evals/probes/` and `make live-ab` for what the tools change. The control arm
(`--profile no-tools`) is here to make that separation measurable rather than assumed.
