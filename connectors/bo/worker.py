...
Run it with `python -m connectors.bo.worker`. It polls one queue (`connector-bo`, derived from the
...
from connectors.bo import activities as _activities  # noqa: F401 — registration side effect
from connectors.bo import workflows as _workflows  # noqa: F401 — registration side effect
