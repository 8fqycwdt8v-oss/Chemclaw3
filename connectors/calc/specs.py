...
They used to live in `workflows/models.py`, which imports `calc.complexes`, `calc.conformers`,
`calc.reaction` and `calc.xtb_scan` for the *result* types alongside them. Measured on `main`,
